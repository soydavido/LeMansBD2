 ...
 * @author RojeruSan
 */
public class Reporte8_vista extends javax.swing.JFrame {
  ...
  public Reporte8_vista() {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       ...
       String ano = combo_ano.getSelectedItem().toString();
        ...
        this.lista = reporte_conexion.reporte8(ano);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Reporte8_vista.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Reporte8_vista().setVisible(true);
            }
        });
    }
