 ...
 * @author RojeruSan
 */
public class Reporte9_vista extends javax.swing.JFrame {
  ...
  public Reporte9_vista() {
    ...
    private void initComponents() {
        ...
        jPanel1.add(txt_participaciones, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 470, 280, 40));
        ...
        btnanterior1.setFont(new java.awt.Font("Tahoma", 0, 24)); // NOI18N
        ...
        jPanel1.add(btnanterior1, new org.netbeans.lib.awtextra.AbsoluteConstraints(630, 150, 170, 50));
        ...
        jPanel1.add(btnsiguiente1, new org.netbeans.lib.awtextra.AbsoluteConstraints(830, 150, 170, 50));
    ...
    public void mostrar(){
        ...
        txt_participaciones.setText(lista.get(contador).getEdad());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Reporte9_vista.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Reporte9_vista().setVisible(true);
            }
        });
    }
