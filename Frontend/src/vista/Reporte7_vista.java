 ...
 * @author RojeruSan
 */
public class Reporte7_vista extends javax.swing.JFrame {
  ...
  public Reporte7_vista() {
    ...
    private void initComponents() {
        ...
        jPanel1.add(txt_edad, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 470, 280, 40));

        jLabel15.setFont(new java.awt.Font("Tahoma", 0, 24)); // NOI18N
        jLabel15.setText("Edad en ese entonces:");
        jPanel1.add(jLabel15, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 470, 250, 40));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       ...
       String ano = combo_ano.getSelectedItem().toString();
        ...
        this.lista = reporte_conexion.reporte7(ano);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Reporte7_vista.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Reporte7_vista().setVisible(true);
            }
        });
    }
