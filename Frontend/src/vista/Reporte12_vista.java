 ...
 * @author RojeruSan
 */
public class Reporte12_vista extends javax.swing.JFrame {
  ...
  public Reporte12_vista() {
    ...
    private void initComponents() {
        ...
        spiner_numero_equipo = new javax.swing.JSpinner();
        ...
        jPanel1.add(nohay, new org.netbeans.lib.awtextra.AbsoluteConstraints(590, 120, 380, 40));
        ...
        spiner_numero_equipo.setFont(new java.awt.Font("Tahoma", 0, 36)); // NOI18N
        jPanel1.add(spiner_numero_equipo, new org.netbeans.lib.awtextra.AbsoluteConstraints(900, 60, 80, 40));
        ...
        etiquetaTiempo1.setText("Datos del Automovil");
        jPanel1.add(etiquetaTiempo1, new org.netbeans.lib.awtextra.AbsoluteConstraints(970, 180, 390, 90));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       ...
       int numero= Integer.parseInt(spiner_numero_equipo.getValue().toString());
        
        this.lista = reporte_conexion.reporte12(numero);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Reporte12_vista.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Reporte12_vista().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JSpinner spiner_numero_equipo;
